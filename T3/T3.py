...
def extract_pdf_text(pdf_path):
    ...
    with open("C:/Users/royba/Downloads/stage/text.txt", "w", encoding="utf-8") as f:
        f.write(full_text)
    return full_text
...
def generate_answer_from_retrieved_chunks(query: str, results) -> str:
    ...
    print(context[:1000], "...")  # print first 1000 chars to check
...
if __name__ == "__main__":
    ...
    if total_objects == 0:
        ...
        save_chunks_to_file(chunks,"C:/Users/royba/Downloads/stage/chunks.txt")
        print("✅ Chunks stored in Weaviate!")
    else:
        print(f"✅ Found {total_objects} existing chunks in Weaviate, skipping upload.")
    
    query = "What is Understanding the needs and expectations of interested parties?"
    results = retrieve_relevant_chunks(query)
    print("✅ Retrieved relevant chunks:")
    for result in results.objects:
        print(f"chunk_id: {result.properties['chunk_id']}, Text: {result.properties['content'][:100]}...")
